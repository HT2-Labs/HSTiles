...
const makeProps = (props?: any) => {
  return {
    ...
    date: "12/03/19",
    title: props && props.title ? props.title : lorem.generateSentences(5),
    description: props && props.description ? props.description : lorem.generateSentences(1),
...
export const myPlanItems = [
  ...
  makeProps({
    title: "Bananas is the relationship between managing change, stress and men and women's health 😱",
  ...
  makeProps({ title: lorem.generateSentences(5) }),
  makeProps({
